...
* `quarto check install` must operate without error 
  ...
  [>] Checking basic markdown render....OK
   ...
   It is better if you have TinyTeX installed to work with Quarto (<https://quarto.org/docs/output-formats/pdf-engine.html#installing-tex>), but not mandatory of the tutorial 
