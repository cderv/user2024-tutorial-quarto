...
![](images/quarto-project.png){.drop fig-alt="Files panel in RStudio showing my-doc.qmd and _quarto.yml." width=80%}
:::

::: {.column .fragment .fade-left width="50%"}
This is not.

![](images/not-quarto-project.png){.drop fig-alt="Files panel in RStudio showing only my-doc.qmd." width=80%}
:::
:::
...
## When should code be re-run? {#computations-rerun .smaller}
...
```{.yaml style='margin-bottom: 0.5rem'}
execute:
...
## Freeze vs. cache {#freeze-cache .smaller}
